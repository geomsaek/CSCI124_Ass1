...
// function will combine the records of a secondary structure. 
void combineRecords(int &, int, struct student database[], struct student secondary[], int, int []);
...
void createVersionCase(char [], char [], char [], bool);
